# Skip p10k config when using a different prompt theme
[[ ${PROMPT_THEME:-p10k} == p10k ]] || return 0

# Generated by Powerlevel10k configuration wizard on 2025-02-15 at 10:24 CST.
